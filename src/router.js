    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          name: "css",
          component: CSS,
          meta: { title: "CSS | by 卫思勉" }
        },
        {
          path: "javascript",
          name: "javascript",
          component: JavaScript,
          meta: { title: "JavaScript | by 卫思勉" }
        },
        {
          path: "userinfo",
          name: "userinfo",
          component: UserInfo,
          meta: { title: "前端教程 | 个人信息" }
        },
        {
          path: "messagewall",
          name: "messagewall",
        ...
        },
        {
          path: "enjoymusic",
          name: "enjoymusic",
          component: EnjoyMusic,
          meta: { title: "前端教程 | 浸在美曲" }
        },
        {
          path: "aboutme",
          name: "aboutme",
          component: AboutMe,
          meta: { title: "前端教程 | 关于作者" }
        },
        {
          path: "vip/course",
          name: "vipcourse",
          component: VipCourse,
          meta: { title: "前端教程 | VIP专区" }
        },
        {
        ...
        {
          path: "vip/course/css/play",
          name: "vip_css",
          component: VIP_CSS,
          meta: { title: "前端教程 | CSS VIP课程" }
        },
        {
          path: "vip/course/javascript/play",
          name: "vip_javascript",
          component: VIP_JAVASCRIPT,
          meta: { title: "前端教程 | JAVASCRIPT VIP课程" }
        }
      ]
    },
    {
      ...
      children: [
        {
          ...
          meta: { title: "前段教程 | 后台首页" }
        },
        {
          path: "manageusers",
          name: "manageusers",
          component: ManageUsers,
          meta: { title: "前段教程 | 用户管理" }
        },
        {
          path: "operalog",
          name: "operationlog",
          component: OperaLog,
          meta: { title: "前段教程 | 操作日志" }
        },
        {
          path: "loginlog",
          name: "loginlog",
          component: LoginLog,
          meta: { title: "前段教程 | 登录日志" }
        },
        {
          path: "registerlog",
          name: "registerlog",
          component: RegisterLog,
          meta: { title: "前段教程 | 注册日志" }
        },
        {
          path: "signlog",
          name: "signlog",
          component: SignLog,
          meta: { title: "前段教程 | 签到信息" }
        },
        {
          path: "edit/html5",
          name: "edithtml5",
          component: EditHTML,
          meta: { title: "前段教程 | 编辑HTML" }
        },
        {
          path: "edit/css",
          name: "editcss",
          component: EditCSS,
          meta: { title: "前段教程 | 编辑CSS" }
        },
        {
          path: "edit/javascript",
          name: "editjavascript",
          component: EditJavaScript,
          meta: { title: "前段教程 | 编辑JavaScript" }
        },
        {
          path: "addarticle",
          name: "addarticle",
          component: AddArticle,
          meta: { title: "前段教程 | 添加文章" }
        },
        {
          path: "managemusic",
          name: "managemusic",
          component: ManageMusic,
          meta: { title: "前段教程 | 歌曲管理" }
        },
        {
          path: "specificarticles",
          name: "specificarticles",
          component: SpecificArticle,
          meta: { title: "前段教程 | 文章统计" }
        },
        {
          path: "message/html",
          name: "htmlmessage",
          component: HTMLMessage,
          meta: { title: "前段教程 | VIP课程 HTML留言" }
        },
        {
          path: "message/css",
          name: "cssmessage",
          component: CSSMessage,
          meta: { title: "前段教程 | VIP课程 CSS留言" }
        },
        {
          path: "message/js",
          name: "jsmessage",
          component: JSMessage,
          meta: { title: "前段教程 | VIP课程 JS留言" }
        },
        {
          path: "message/community",
          name: "communitymessage",
          component: CommunityMessage,
          meta: { title: "前段教程 | 社区留言" }
        },
        {
          path: "buycourselog",
          name: "buycourselog",
          component: BuyCourseLog,
          meta: { title: "前段教程 | 课程购买记录" }
        },
        {
          path: "data/homepage",
          name: "homepagedata",
          component: HomePageData,
          meta: { title: "前段教程 | 首页数据" }
        },
        {
          path: "manage/vip/course/html",
          name: "vipcoursehtml",
          component: VipCourseHtml,
          meta: { title: "VIP课程管理 | HTML教程" }
        },
        {
          path: "manage/vip/course/css",
          name: "vipcoursecss",
          component: VipCourseCss,
          meta: { title: "VIP课程管理 | CSS教程" }
        },
        {
          path: "manage/vip/course/js",
          name: "vipcoursejs",
          component: VipCourseJs,
          meta: { title: "VIP课程管理 | JavaScript教程" }
        }
      ]
    },
    // 查询路由
...
vueRouter.beforeEach((to, from, next) => {
  ...
  if (
    ...
    to.path == "/home/html5" ||
    to.path == "/home/css" ||
    to.path == "/home/javascript" ||
    to.path == "/home/messagewall" ||
    to.path == "/home/aboutme" ||
    to.path == "/home/enjoymusic" ||
    to.path == "/home/vip/course" ||
    to.path == "/admin/login" ||
    to.path == "/home/vip/course/html5/play" ||
    to.path == "/home/vip/course/css/play" ||
    to.path == "/home/vip/course/javascript/play"
  ) {
    next();
  } else {
    if (to.path == "/search") {
      ...
      if (
        to.path == "/admin/index/data/homepage" ||
        to.path == "/admin/index/manage/vip/course/js" ||
        to.path == "/admin/index/manage/vip/course/css" ||
        to.path == "/admin/index/manage/vip/course/html" ||
        to.path == "/admin/index/buycourselog" ||
        to.path == "/admin/index/message/html" ||
        to.path == "/admin/index/message/css" ||
        to.path == "/admin/index/message/js" ||
        to.path == "/admin/index/message/community" ||
        to.path == "/admin/index/specificarticles" ||
        to.path == "/admin/index/managemusic" ||
        to.path == "/admin/index/addarticle" ||
        to.path == "/admin/index/edit/html5" ||
        to.path == "/admin/index/edit/css" ||
        to.path == "/admin/index/edit/javascript" ||
        to.path == "/admin/index/signlog" ||
        to.path == "/admin" ||
        to.path == "/admin/index" ||
        to.path == "/admin/index/manageusers" ||
        to.path == "/admin/index/operalog" ||
        to.path == "/admin/index/loginlog" ||
        to.path == "/admin/index/registerlog"
      ) {
        if (adminLogin) next();
        else {
